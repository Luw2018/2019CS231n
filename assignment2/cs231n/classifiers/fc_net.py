...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        lay1_scores, lay1_cache = affine_relu_forward(X, self.params['W1'], self.params['b1'])
        lay2_scores, lay2_cache = affine_forward(lay1_scores, self.params['W2'], self.params['b2'])
        scores = lay2_scores
        ...
        dx2, dw2, db2 = affine_backward(dout, lay2_cache)
        grads['W2'] = dw2 + self.reg * self.params['W2']
        grads['b2'] = db2
        dx1 , dw1, db1 = affine_relu_backward(dx2, lay1_cache)
...
#         self.use_dropout = dropout 
    ...
    def loss(self, X, y=None):
        ...
        dx , dw , db = affine_backward(dhout , lay_cache[self.num_layers])
        ...
        for idx in range(self.num_layers-1):
            ...
            if self.use_batchnorm:
                dx, dw, db, dgamma, dbeta = affine_bn_relu_backward(dhout, lay_cache[lay])
            else:
                dx, dw, db = affine_relu_backward(dhout, lay_cache[lay])
